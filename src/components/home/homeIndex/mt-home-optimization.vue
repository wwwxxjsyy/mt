  ...
  data() {
    return {
      foodlist: [
        {
          foodpic:
            "http://youimg1.c-ctrip.com/target/100t0d0000006s5zkA325.jpg",
          shopname: "魏家凉皮 (科技三路店)",
          recommend: "根据您看过的店推荐",
          shoppic:
        ...
        {
          foodpic:
            "http://img5.imgtn.bdimg.com/it/u=3473710707,611514416&fm=26&gp=0.jpg",
          shopname: "肯德基宅急送（唐兴路店）",
          recommend: "附近热卖好店",
          shoppic:
            "http://cdn.clm02.com/ezp9.com/28146/28146_2.png"
        },
        {
          foodpic:
            "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1562550878&di=b56ee730a884f22e60949ed1dfb6d2f1&imgtype=jpg&er=1&src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201609%2F11%2F20160911182823_GkQeW.jpeg",
          shopname: "汉堡王（T11西安239311店）",
          recommend: "根据您看过的店推荐",
          shoppic:
            "http://img5.imgtn.bdimg.com/it/u=2095573645,475601590&fm=26&gp=0.jpg"
        },
        {
          foodpic:
            "https://p0.meituan.net/waimaipoi/d601804ac552730dccea6bda6697329426624.jpg",
          shopname: "渭南时辰包子(团结南路店)",
          recommend: "根据您看过的店推荐",
          shoppic:
            "http://img5.imgtn.bdimg.com/it/u=3721691357,3522887404&fm=26&gp=0.jpg"
        }
      ],
      goodfood: [
        {
...
.home-optimization-food {
  width: 100%;
}
.home-optimization-food ul {
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between;
}
.home-optimization-food ul li {
  width: 48%;
  height: 2.7rem;
  background: #fff;
  margin-top: 0.2rem;
...
.home-optimization-foodname {
  width: 100%;
  height: 0.8rem;
  display: flex;
}
.home-optimization-foodname-left {
  width: 70%;
  height: 0.7rem;
  display: flex;
...
.home-optimization-foodname-left h3 {
  width: 100%;
  font-weight: bold;
  white-space: nowrap;
  overflow: hidden;
...
.home-optimization-foodname-left p {
  width: 100%;
  white-space: nowrap;
  overflow: hidden;
  text-overflow: ellipsis;
...
.home-optimization-selectedmenu {
  width: 90%;
  height: 1.1rem;
  background: #fff;
  border-radius: 0.1rem;
...
.home-optimization-selected-btm {
  width: 100%;
  height: 1.6rem;
  display: flex;
...
.home-optimization-selectedmen-left {
  width: 65%;
  height: 100%;
  display: flex;
  flex-direction: column;
...
.home-optimization-selectedmen-left b {
  font-size: 0.28rem;
  font-weight: bolder;
  white-space: nowrap;
  overflow: hidden;
...
.home-optimization-selectedmen-left span {
  font-size: 0.3rem;
  color: red;
}
.home-optimization-food ul li .home-optimization-selectedmen-right img {
  width: 1rem;
  height: 1rem;
